<style>
	...
	<div id="carnovos" class="carousel slide" data-ride="carousel2" data-interval="0">
		...
		<!--</INDICADORES> -->
		<a class="carousel-control-prev" style="display:flex; width:12%;" href="#carnovos" role="button"
			data-slide="prev">
			<span class="material-symbols-outlined" style=" font-size:55px; color:black">arrow_back_ios</span>
		</a>
		<a class="carousel-control-next" style="display:flex; width:12%;" href="#carnovos" role="button"
			data-slide="next">
